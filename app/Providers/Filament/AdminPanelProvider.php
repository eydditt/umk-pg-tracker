 ...
 * AdminPanelProvider
 * ============================================================
 * Configures the main Filament admin panel for UMK PG Tracker.
 *
 * Maintained by : Aidit (original developer)
 * System        : UMK PG Tracker v1.0
 * Faculty       : FSDK — Universiti Malaysia Kelantan
 * ============================================================
 *
 * SECTIONS IN THIS FILE:
 *   1. Panel Core Config      — brand, favicon, colors, auth
 *   2. HEAD_END Hook          — global CSS (login inputs + print styles)
 *   3. BODY_END Hook          — login slideshow + print function + easter egg
 *   4. AUTH_LOGIN Hook        — login page branding (logo + title)
 *   5. AUTH_PASSWORD Hook     — password reset page branding
 *   6. Middleware Stack       — session, CSRF, auth
 * ============================================================
 */
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            // ── 2. HEAD_END HOOK — Global CSS ────────────────────────
            // Injects:
            //   - Login page input field styling (glass-morphism dark inputs)
            //   - Print media styles for dashboard printing
            ->renderHook(
                PanelsRenderHook::HEAD_END,
                fn() => Blade::render('
                    <style>
                        /* ── Login Page: Glass Input Fields ── */
                        ...
                        @media print {
                            ...
                            * {
                            ...
                            /* Inject print report header via CSS */
                            ...
                            .fi-section { padding: 6px !important; }

                            .fi-wi-stats-overview-stat { padding: 8px !important; }
                            .fi-wi-stats-overview-stat-value { font-size: 18px !important; }
                            .fi-wi-stats-overview-stat-label,
                            .fi-wi-stats-overview-stat-description { font-size: 9px !important; }
                ...
                ->renderHook(
                    ...
                    fn() => Blade::render('
                        ...
                        // ════════════════════════════════════════════════════
                        // Runs only on the login page (.fi-simple-layout).
                        // Cross-fades between UMK campus images every 5s.
                        // To add/remove images, edit the slides array below.
                        // ════════════════════════════════════════════════════
                        (function() {
                            const slides = [
                            ...
                            if (mainCtn) {
                                mainCtn.style.position = "relative";
                                mainCtn.style.zIndex = "10";
                            }
                         ...
                         <script src="/js/app-extras.js" defer></script>

                    ')
                )

            // ── 4. AUTH LOGIN HOOK — Login Page Branding ─────────────
            // Renders the FSDK logo and system title above the login form.
            // To swap the logo, update the image path below.
            ->renderHook(
                ...
                fn() => Blade::render('
                    <div style="text-align: center; margin-bottom: 1.5rem;">
                        ...
                        <h2 style="color:#ffffff; font-size:1.3rem; font-weight:700; margin:0 0 0.5rem;
                                   text-shadow:0 1px 3px rgba(0,0,0,0.4);">
                            UMK PG Tracker
                        </h2>
                        <p style="color:rgba(255,255,255,0.65); font-size:0.78rem; font-weight:400;
            ...
            // ── 5. AUTH PASSWORD RESET HOOK — Reset Page Branding ────
            // Renders the heading and instructions above the reset form.
            ->renderHook(
            ...
            // ── 7. MIDDLEWARE STACK ───────────────────────────────────
            // Standard Filament middleware — do not reorder.
            ->middleware([
